...
* Update manpages, see [gen-manpages.sh](https://github.com/mastermind4242/tubacle/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/mastermind4242/tubacle-detached-sigs.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://github.com/mastermind4242/tubacle.git
...
- Detached signatures will then be committed to the [tubaclecoin-detached-sigs](https://github.com/mastermind4242/tubacle-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/mastermind4242/tubacle/releases/new) with a link to the archived release notes.
